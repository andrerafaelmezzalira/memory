...
final class PrevalentSystemGuard  {
	...
	final PrevaylerData executeQuery(final Query sensitiveQuery) throws Exception {
		synchronized (this) {
			if (_prevalentSystem == null)
				throw new Error(
	...
	static final PrevaylerData deepCopyParallel(
			final PrevaylerData original)
			throws IOException, ClassNotFoundException {
	...
	final PrevaylerData _prevalentSystem;
	long _systemVersion;
